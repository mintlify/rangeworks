...
Drive is a place you can store different files and share them with others. When you select the drive tab, your screen should look something like this:
...
I want to upload a file to drive, so I'm going to hit the '+' button.

![Add to Drive](/images/drive/add-to-drive.png)

After selecting file upload, I can choose a file from my computer to upload onto the drive. I selected the file I want on the drive, a chart, and clicked on open. When you've succesfully chosen your file or files, you'll see this screen:
